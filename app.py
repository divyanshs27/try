# -*- coding: utf-8 -*-
"""
Created on Mon Oct  5 11:49:34 2020
...
def home():
    ...
    return render_template("index.html", education_status = education_status, marital_status = marital_status, payment_status = payment_status, alert_message = alert_message, success_message = success_message)
